...
<div class="card" style="max-width:650px;">
  <form method="POST" action="{{ route('admin.quan-ly-loai-don.cap-nhat', $documentType->id) }}">
    @csrf
    ...
    <div class="form-group">
      ...
      <select id="is_active" name="is_active" class="form-control">
        <option value="1" @selected(old('is_active', (int) $documentType->is_active) == 1)>Hoạt động</option>
        <option value="0" @selected(old('is_active', (int) $documentType->is_active) == 0)>Không hoạt động</option>
      </select>
    </div>
